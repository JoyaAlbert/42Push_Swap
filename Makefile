SRC				=	push_swap.c rotatemoves.c rrotatemoves.c swap_moves.c push_moves.c short_sort.c utils/ft_atoi.c utils/list_utils.c utils/more_list_utils.c utils/arg_check.c\
